...
public class ApkBuilder {
	...
	public static void generateChannel(String channel, Apk apk, File out) throws Exception {
		if (apk.isV2()) {
			System.out.println("这是V2签名的apk，现在用V2的方式来注入渠道信息:" + channel);
			generateV2Channel(channel, apk, out);
		} else if (apk.isV1()) {
			System.out.println("这是V1签名的apk，现在用V1的方式来注入渠道信息" + channel);
